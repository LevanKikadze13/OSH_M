...
const ControlMechanisms = () => {
    ...
    const renderMechanisms = () => {
        ...
        return currentMechanisms.map((mechanism) => (
            <ListGroupItem key={mechanism.id} className="d-flex justify-content-between align-items-center">
    ...
    return (
        <div className="control-mechanisms">
            <Card>
                <Card.Header as="h5" className='text-center'>Control Mechanisms</Card.Header>
